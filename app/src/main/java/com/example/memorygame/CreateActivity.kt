            ...
            photoReference.putBytes(imageByteArray)
                .continueWithTask{ photoUploadTask ->
                    ...
                    if(!downloadUrlTask.isSuccessful){
                        Log.e(TAG,"Firebase error",downloadUrlTask.exception)
        ...
        db.collection("games").document(gameName)
            ...
            .addOnCompleteListener{ gameCreationTask ->
                ...
                if(!gameCreationTask.isSuccessful){
                    Log.e(TAG,"Excetion with game creation",gameCreationTask.exception)
                    Toast.makeText(this,"Failed game Creation",Toast.LENGTH_LONG).show()
                    return@addOnCompleteListener
                }
                Log.i(TAG,"Successfully creadted game $gameName")
                AlertDialog.Builder(this)
